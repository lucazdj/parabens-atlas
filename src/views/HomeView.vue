<template>
  <div class="route-container">
    <div class="glass-card">
      ...
      <!-- Header Content -->
      <h1 class="title">Parabéns, {{ settings.hostName }}!</h1>
      <p class="subtitle">Celebrando mais um ciclo</p>
      ...
      <div class="countdown-container" v-else>
        <div class="countdown-box" style="grid-column: span 4; padding: 1rem;">
          <span class="countdown-val" style="font-size: 1.1rem; color: var(--clr-accent);">🎉 É hoje! A comemoração começou! 🎉</span>
        </div>
      </div>
      ...
      <div class="details-list">
        ...
        <div class="detail-item">
          ...
          <div class="detail-content">
            <h4>Onde</h4>
            <p>{{ settings.locationName }}<br><small>{{ settings.locationAddress }}</small></p>
          </div>
        </div>
      </div>
      ...
      <div class="invite-footer">
        Feito com carinho para comemorar com você!
      </div>
...
export default {
  ...
  setup() {
    ...
    const rsvpLink = computed(() => {
      const text = encodeURIComponent(`Olá ${settings.hostName}! Fiquei muito feliz com o convite. Confirmo minha presença na sua festa de aniversário no dia 11 de Julho! 🎉`);
